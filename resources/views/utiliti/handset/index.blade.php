...
function do_create()
{
  window.location = "/utiliti/handset/create";
}

function do_edit(doc_id)
{
  // alert(doc_id);
  window.location = "/utiliti/handset/edit/"+doc_id;
}
...
function do_page()
{
  ...
  if(carian.trim()==''){
      window.location = '/utiliti/handset';
  } else {
      window.location = '/utiliti/handset?carian='+carian;
  }
}
</script>
...
@endphp
      ...
      <div class="box-body">
        ...
        <div class="x_panel">
            ...
            <h6 class="panel-title"><font color="#000000"><b>SENARAI HANDSET</b></font></h6>
          </header>
			  </div>
      </div>
      <br />
