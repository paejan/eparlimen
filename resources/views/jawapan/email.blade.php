...
<body>
    ...
    Assalamualaikum,
    <br><br>
    Untuk makluman pihak Tuan/Puan dikehendaki untuk memberikan jawapan pada ketetapan berikut:<br><br>
    Soalan :  <b>{{ strtoupper($data['dewan_desc']) }}</b><br>
    Persidangan Parlimen :  <b>{{ $data['sidang'] }}</b><br>
    Tarikh Sasaran Jawapan :  <b>{{ DisplayDate($data['tarikh']) }}, ({{ $data['hari'] }})</b><br><br>
